...
- This seems to be for a relatively general audience, with the goal of educating about redlining through concrete data, to show its history and its effects. It might be targeted at those who would be presently impacted by historical redlining. By showing maps overlaid on major present-day cities, it illustrates the relevance of redlining to modern America and leads viewers to understand its lasting effects where they live.
...
- The pattern of NDVI decreasing in more redlined neighborhoods seems reliably consistent across cities throughout the United States. A notable exception is Birmingham, where the NDVI of the most redlined neighborhoods is similar to that of the most redlined ones. While a downward trend is visible, it's possible that a higher overall Black population in Birmingham compared to other cities might have made it so that there were many more redlined neighborhoods, and so less of a disparity is visible.
